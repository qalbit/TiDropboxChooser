...
class AppStoreInterstitial {
    ...
    public static class NativeFragment extends DialogFragment  {
        ...
        public Dialog onCreateDialog(Bundle savedinstanceState)  {
            ...
            try {
            	View v = getActivity().getLayoutInflater().inflate(TiRHelper.getResource("layout.app_store_interstitial"), null);

                setStrings(v, isDropboxInstalled(getActivity()));

                Button okButton = (Button) v.findViewById(TiRHelper.getResource("id.dbx_bottom_bar_ok_button"));
                ...
                Button cancelButton = (Button) v.findViewById(TiRHelper.getResource("id.dbx_bottom_bar_ok_button"));
    ...
    public static class SupportFragment extends android.support.v4.app.DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedinstanceState) {
            ...
            try {
                ...
                Button cancelButton = (Button) v.findViewById(TiRHelper.getResource("id.dbx_bottom_bar_cancel_button"));
                cancelButton.setOnClickListener(new OnClickListener() {
                    public void onClick(View v_clicked) {
                        frag.dismiss();
                    }
    ...
    private static void setStrings(View v, boolean needUpdate) throws ResourceNotFoundException {
        TextView title = (TextView) v.findViewById(TiRHelper.getResource("id.dbx_install_title"));
        TextView main = (TextView) v.findViewById(TiRHelper.getResource("id.dbx_install_main"));
        TextView sub = (TextView) v.findViewById(TiRHelper.getResource("id.dbx_install_sub"));
        Button okButton = (Button) v.findViewById(TiRHelper.getResource("id.dbx_bottom_bar_ok_button"));
        Button cancelButton = (Button) v.findViewById(TiRHelper.getResource("id.dbx_bottom_bar_cancel_button"));

        if (needUpdate) {
            title.setText(TiRHelper.getResource("string.dbx_update"));
            main.setText(TiRHelper.getResource("string.dbx_update_main"));
            sub.setText(TiRHelper.getResource("string.dbx_update_sub"));
            okButton.setText(TiRHelper.getResource("string.dbx_update_button_ok"));
        } else {
            // first-time install
            title.setText(TiRHelper.getResource("string.dbx_install"));
            main.setText(TiRHelper.getResource("string.dbx_install_main"));
            sub.setText(TiRHelper.getResource("string.dbx_install_sub"));
            okButton.setText(TiRHelper.getResource("string.dbx_install_button_ok"));
        }
        cancelButton.setText(TiRHelper.getResource("string.dbx_install_button_cancel"));
    }
