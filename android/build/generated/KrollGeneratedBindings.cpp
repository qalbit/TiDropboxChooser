...
namespace titanium {
	namespace bindings {
		...
		class TiDropboxChooserBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* TiDropboxChooserBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.dropbox.TiDropboxChooserModule", ::ti::dropboxchooser::TiDropboxChooserModule::bindProxy, ::ti::dropboxchooser::TiDropboxChooserModule::dispose}
			};
